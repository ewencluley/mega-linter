...
- Linter versions upgrades
  ...
  - [ktlint](https://ktlint.github.io) from 0.40.0 to **0.41.0** on 2021-03-19
  - [phpstan](https://phpstan.org/) from 0.12.81 to **0.12.82** on 2021-03-19
  - [sfdx-scanner](https://forcedotcom.github.io/sfdx-scanner/) from 2.6.0 to **2.7.0** on 2021-03-19
  - [swiftlint](https://github.com/realm/SwiftLint) from 0.43.0 to **0.43.1** on 2021-03-19
<!-- linter-versions-end -->
