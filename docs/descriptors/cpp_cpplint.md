...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'c++', 'cxx', 'c', 'cuh', 'hxx', 'cpp', 'cu', 'h', 'hpp', 'hh', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,c++,cxx,c,cuh,hxx,cpp,cu,h,hpp,hh,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'cuh', 'h', 'hpp', 'hh'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,cuh,h,hpp,hh
        --headers=hpp,hxx
        --headers=hpp
